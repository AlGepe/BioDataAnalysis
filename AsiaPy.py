...
allThemFiles = listdir('MZSB/sbml')
allThemDicts = []
allThemDicts = dict4all(allThemFiles)
#print getMatches(allThemDicts[0])


# In[163]:

#humanoids = allThemDicts[0]['humans']
allReact = allThemDicts[0]
#print sumDict(humanoids)
infoMolec('M_hmgcoa_c', allReact)


# In[99]:

print type(allThemDicts[0])

oneDict = allThemDicts[0]
i=0
for molec in oneDict['humans']:
    i += oneDict['humans'][molec]
    
print i#sum(oneDict['humans'])
